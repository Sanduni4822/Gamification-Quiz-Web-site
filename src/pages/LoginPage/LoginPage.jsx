...
const ErrorModal = ({ title, message, onClose }) => (
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 backdrop-blur-sm z-50">
    <div className="bg-purple-700 p-6 rounded-2xl shadow-xl w-80 max-w-sm text-center border-4 border-purple-300 relative">
      {/* Alert Icon */}
      <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-16 h-16 flex items-center justify-center bg-red-600 rounded-full border-4 border-white shadow-md">
        <span className="text-white text-4xl font-bold">!</span>
      </div>

      {/* Title */}
      <h2
        className="text-white text-xl font-title mt-10 mb-4 leading-snug"
        style={{
...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-cover bg-center px-4" style={{ backgroundImage: "url('/path/to/your/background-image.jpg')" }}>
